...
try:
    DEBUG = bool(strtobool(os.environ.get('DJANGO_DEBUG', 'True').strip()))
except ValueError:
    DEBUG = True  # Default to True if an invalid value is found
...
LANGUAGE_CODE = 'en-US'
TIME_ZONE = os.environ.get('TZ', 'Europe/Berlin')  # keep this if you want
DATE_FORMAT = 'd.m.Y'
